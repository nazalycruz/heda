...
class CILogViewer {
    ...
    private static $levelsIcon = [
      ...
      'DEBUG' => 'fas fa-bug',
      'REGINI' => 'fas fa-info-circle',
      'CALCULO' => 'fas fa-info-circle',
			'INICIO' => 'fas fa-info-circle',
			'CORREO' => 'fas fa-info-circle',
    ];
    ...
    const LOG_LINE_START_PATTERN = "/((INFO)|(ERROR)|(REGINI)|(CALCULO)|(INICIO)|(CORREO)|(DEBUG)|(ALL))[\s\-\d:]+(-->)/";
    const LOG_DATE_PATTERN = "/(\d{4,}-[\d\-:]{2,})\s([\d:]{2,})/";
    const LOG_LEVEL_PATTERN = "/^((ERROR)|(INFO)|(REGINI)|(CALCULO)|(INICIO)|(CORREO)|(DEBUG))/";
